...
const comments_1 = __importDefault(require("../../controllers/answers/comments"));
const router = new koa_router_1.default({ prefix: '/api/questions/:questionId/answers/:answerId/comments' });
